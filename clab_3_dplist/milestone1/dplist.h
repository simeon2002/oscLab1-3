 ...
 */
dplist_t *dpl_create(
        void* (*element_copy)(void *element), // pointer towards the pointer of element_copy with pointer to the element
        void (*element_free)(void **element), // pointer towards the function with a pnointer to the pointer of the element.
